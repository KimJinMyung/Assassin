...
public class DataManager : MonoBehaviour
{
    ...
    public Dictionary<int, PlayerData> LoadPlayerData { get; private set; }
    ...
    {
        ReadMonsterData(nameof(MonsterData), MonsterFileType.Monster_Info);
    ...
    {
        LoadedMonsterDataList = new Dictionary<int, MonsterData>();
    ...
    {
        LoadPlayerData = new Dictionary<int, PlayerData>();
